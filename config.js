...
module.exports = {
   ...
   // String Values
   SESSION_ID: process.env.SESSION_ID || "", // KermLite~ZJNsbxg3
   ...
   SUDO: process.env.SUDO || "254798892155",
   ...
   PACKNAME: process.env.PACKNAME || "Foster⚡️",
   WELCOME_MSG: process.env.WELCOME_MSG || "Hi @user Welcome to @foster",
